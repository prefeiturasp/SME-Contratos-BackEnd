...
)  # (sme_coad_apps/config/settings/base.py - 3 = sme_coad_apps/)
APPS_DIR = ROOT_DIR.path("sme_coad_apps")
...
MIGRATION_MODULES = {"sites": "sme_coad_apps.contrib.sites.migrations"}
...
ADMINS = [("""Weslei Souza""", "weslei.souza@amcom.com.br")]
