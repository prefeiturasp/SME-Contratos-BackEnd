...
def contrato(gestor, suplente):
    return mommy.make('Contrato', data_assinatura=datetime.date(2019, 1, 1),
                      ...
                      suplente=suplente, data_encerramento=datetime.date(2019, 4, 11)
                      )
...
# def test_gera_notificacao_30_dias_repete_apos_7_dias(
#     parametro_notificacao, contrato, notificacao_30_dias_em_2019_3_12):
#     assert NotificacaoVigenciaContrato.objects.all().count() == 1
#
