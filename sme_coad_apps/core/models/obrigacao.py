...
class GrupoObrigacao(ModeloBase):
    ...
    edital = models.ForeignKey(Edital, on_delete=models.CASCADE, related_name="grupos_de_obrigacoes")
...
class Obrigacao(ModeloBase):
    ...
    grupo = models.ForeignKey(GrupoObrigacao, on_delete=models.CASCADE, related_name="obrigacoes")
